...
class BT:
    ...
    def modifyBTToGetPreorderFromLeftPointersOnly(self):
        ...
        node = self.root
        print('\npreorder from left ptrs: ', end=" ")
        while node:
            print(node.value, end=" ")
            node = node.left

    def modifyBTToGetPreorderFromRightPointersOnly(self):
...
post 8 9 4 10 5 2 6 7 3 1
    ...
    print()
    t.modifyBTToGetPreorderFromLeftPointersOnly()
    print()
